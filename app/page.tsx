      ...
      <section className="relative pt-32 pb-20 px-6 overflow-hidden">
        ...
        <div className="relative mx-auto max-w-4xl text-center">
          ...
          <p className="text-lg text-replay-text-secondary max-w-xl mx-auto mb-10 leading-relaxed">
            Replay transforms your Spotify listening history into a beautiful
        ...
        <div className="mx-auto max-w-4xl">
          <div className="rounded-2xl border border-replay-border bg-replay-card p-6 shadow-2xl">
            <div className="flex items-center justify-between mb-6">
              <div>
                <p className="text-xs text-replay-text-muted mb-0.5">demo profile</p>
                <p className="text-sm font-semibold text-replay-text-primary">frank-ocean-era</p>
              </div>
      ...
      <section className="px-6 pb-20">
        <div className="mx-auto max-w-4xl grid sm:grid-cols-3 gap-4">
          ...
          <FeatureCard
            emoji="🎭"
            title="Eras detected"
            description="Replay finds patterns in your history and names your listening phases — the Blonde era, the gym arc, the 3 AM spiral."
          />
          <FeatureCard
            emoji="🔗"
      ...
      <footer className="border-t border-replay-border px-6 py-8">
        <div className="mx-auto max-w-4xl flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs text-replay-text-muted">Replay</span>
          </div>
